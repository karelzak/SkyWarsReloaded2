        ...
        if (shopFile.exists()) {
            ...
            if (storage.contains("items")) {
                for (String item : storage.getStringList("items")) {
                    ...
                    if (itemStack != null) {
                        shopMap.put(ChatColor.stripColor(ItemUtils.getItemName(itemStack)), new ShopItem(itemStack, cost));
                    }
                }
            }
        }
        ...
        if (specShopFile.exists()) {
            ...
            if (storage.contains("items")) {
                for (String item : storage.getStringList("items")) {
                    ...
                    if (itemStack != null) {
                        specShopMap.put(ItemUtils.getItemName(itemStack), new ShopItem(itemStack, cost));
                    }
                }
            }
        }
