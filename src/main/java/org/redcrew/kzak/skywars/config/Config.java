package org.redcrew.kzak.skywars.config;
...
public class Config {
	...
	private void validateConfigValues() {
		...
		if (playerJoinLobby == null) {
			playerJoinLobby =  Sound.ENTITY_SLIME_ATTACK;
